...
const Recommendation = () => (
  <RecommendationStyled>
    ...
    <p> <div id="triangle"> </div>"Marc a été parcticulièrement apprécié par l'ensemble des collègues et par la direction de notre école, pour sa bonne humeure et sa capacité à s'adapter au groupe"</p>
